...
export default function ProductDetailPage() {
  ...
  const mainImgSrc = imgOverride || product.images?.primary || BRAND.placeholderImage;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <Image
              ...
              priority
              onError={() => setImgOverride(BRAND.placeholderImage)}
            />
          </motion.div>
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-black mb-6">{product.name}</h1>

            {formattedPrice && (
              <p className="text-3xl font-bold mb-8" style={{ color: COLORS.primary }}>
                {formattedPrice}
              </p>
            )}
